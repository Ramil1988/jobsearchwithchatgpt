...
function CoverLetter() {
 ...
 const handleSubmit = async () => {
  ...
  if (language === "English") {
   ...
   if (tone === "Casual") {
    toneInstruction = "Rédigez la lettre de motivation dans un style informel.";
   } else {
    toneInstruction =
  ...
  <>
   <AppContainer>
    ...
    {loading ? (
     <LoadingContainer>
      <Spinner />
      <LoadingMessage>Wait, your Cover Letter is generating...</LoadingMessage>
     </LoadingContainer>
    ) : coverLetter ? (
     <CoverLetterContainer>
      ...
      />
      <CopyButton onClick={handleCopyText}>Copy your Cover letter</CopyButton>
